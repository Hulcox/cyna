...
const PageSchema = () => {
  ...
  const columns = ["IP", "CVEs", "CVSS", "Severity", "Cyberscore", "Action"]
      ...
      <div className="flex gap-5 items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <div
            ...
            onClick={() => {
              handleIpSelect("192.168.1.101")
            }}
          ></div>
          <h2
            className={`text-lg font-bold ${
              ipSelected == "192.168.1.101" && "text-red-800"
            }`}
          >
            192.168.1.101
          </h2>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <h2
            className={`text-lg font-bold ${
              ipSelected == "192.168.1.130" && "text-red-800"
            }`}
          >
            192.168.1.130
          </h2>
        ...
        <div className="flex flex-col items-center gap-4">
          <div
            ...
            onClick={() => {
              handleIpSelect("84.55.180.141")
            }}
          ></div>
          <h2
            className={`text-lg font-bold ${
              ipSelected == "84.55.180.141" && "text-red-800"
            }`}
          >
            84.55.180.141
          </h2>
